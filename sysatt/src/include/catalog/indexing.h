...
DECLARE_UNIQUE_INDEX(pg_shsecurity_secid_index, 3401, on pg_shsecurity using btree(secid oid_ops, seckind char_ops, relid oid_ops));
#define SharedSecuritySecidIndexId		3401
DECLARE_UNIQUE_INDEX(pg_shsecurity_secattr_index, 3402, on pg_shsecurity using btree(secid oid_ops, seckind char_ops, relid oid_ops));
#define SharedSecuritySecattrIndexId	3402

DECLARE_UNIQUE_INDEX(pg_security_secid_index, 3406, on pg_security using btree(secid oid_ops, seckind char_ops, relid oid_ops));
#define SecuritySecidIndexId		3406
DECLARE_UNIQUE_INDEX(pg_security_secattr_index, 3407, on pg_security using btree(secid oid_ops, seckind char_ops, relid oid_ops));
