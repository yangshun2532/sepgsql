...
DATA(insert ( 1247 security_acl	  1034 0 -1  -9 1 -1 -1 f x i t f f t 0 _null_));
...
DATA(insert ( 1255 security_acl	  1034 0 -1  -9 1 -1 -1 f x i t f f t 0 _null_));
...
DATA(insert ( 1249 security_acl	  1034 0 -1  -9 1 -1 -1 f x i t f f t 0 _null_));
...
DATA(insert ( 1259 security_acl	  1034 0 -1  -9 1 -1 -1 f x i t f f t 0 _null_));
