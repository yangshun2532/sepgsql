...
echo "svn update"
echo
echo "svn merge -c `expr ${SVNREV} + 1` ./base ./blob-toast  && \\"
echo "svn commit -m 'merge updates of ${SVNBRANCH}/base into ${SVNBRANCH}/blob-toast at r`expr ${SVNREV} + 1`' ./blob-toast && \\"
echo "svn update"
