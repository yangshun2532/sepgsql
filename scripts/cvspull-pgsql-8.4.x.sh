...
echo "svn update"
echo
echo "svn merge -c `expr ${SVNREV} + 1` ./base ./sepgsql-test"
echo "svn diff ./sepgsql-test"
echo "svn commit -m 'merge updates of ${SVNBRANCH}/base into ${SVNBRANCH}/sepgsql-test at `env LANG=C date`' ./sepgsql-test"
echo "svn update"
echo
