...
mv ${RPMSOURCE}/sepgsql-01-sysatt-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-01-sysatt-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-02-core-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-02-core-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-03-gram-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-03-gram-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-04-writable-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-04-writable-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-05-rowlevel-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-05-rowlevel-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-06-perms-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-06-perms-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-07-extra-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-07-extra-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-08-utils-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-08-utils-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-09-tests-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-09-tests-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
mv ${RPMSOURCE}/sepgsql-10-docs-${BASE_MAJOR}.patch	\
    ${RPMSOURCE}/sepgsql-10-docs-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch
...
echo "04) ${RPMSOURCE}/sepgsql-04-writable-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "05) ${RPMSOURCE}/sepgsql-05-rowlevel-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "06) ${RPMSOURCE}/sepgsql-06-perms-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "07) ${RPMSOURCE}/sepgsql-07-extra-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "08) ${RPMSOURCE}/sepgsql-08-utils-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "09) ${RPMSOURCE}/sepgsql-09-tests-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
echo "10) ${RPMSOURCE}/sepgsql-10-docs-${BASE_MAJOR}-r${SEPGSQL_REVISION}.patch"
