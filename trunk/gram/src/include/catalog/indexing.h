...
DECLARE_UNIQUE_INDEX(pg_shsecurity_secid_index, 3401, on pg_shsecurity using btree(secid oid_ops, relid oid_ops, seckind char_ops));
...
DECLARE_UNIQUE_INDEX(pg_security_secid_index, 3406, on pg_security using btree(secid oid_ops, relid oid_ops, seckind char_ops));
