 ...
 *
 * @bootstrap : true, if bootstraping mode.
 */
static inline void pgaceInitialize(bool bootstrap) {
	/* do nothing */
}
 ...
 */
static inline bool pgaceSetDatabaseParam(const char *name, char *argstring) {
	/* do nothing */
	return true;
}
...
static inline bool pgaceIsSecuritySystemColumn(int attrno) {
