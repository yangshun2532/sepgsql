...
DECLARE_UNIQUE_INDEX(pg_security_secid_index, 3401, on pg_security using btree(datid oid_ops, secid oid_ops));
#define SecuritySecidIndexId		3401
DECLARE_UNIQUE_INDEX(pg_security_secattr_index, 3402, on pg_security using btree(datid oid_ops, secattr text_ops));
