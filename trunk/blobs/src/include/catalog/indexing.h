...
DECLARE_UNIQUE_INDEX(pg_largeobject_data_loid_pn_index, 2967, on pg_largeobject_data using btree(loid oid_ops, pageno int4_ops));
#define LargeObjectDataLOidPNIndexId	2967
