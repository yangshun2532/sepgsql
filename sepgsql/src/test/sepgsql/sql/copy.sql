...
(
	...
	y	text,
	z	text
) SECURITY CONTEXT (z='system_u:object_r:sepgsql_ro_table_t:s0');
...
(
	...
	t	text,
	u	text
) SECURITY CONTEXT (t='system_u:object_r:sepgsql_fixed_table_t:s0',
                    u='system_u:object_r:sepgsql_secret_table_t:s0');
