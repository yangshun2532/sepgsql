...
{ 1255, {"proname"},			19, -1, NAMEDATALEN,  1, 0, -1, -1, false, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
...
{ 1255, {"procost"},		   700, -1, 4,	5, 0, -1, -1, FLOAT4PASSBYVAL, 'p', 'i', 'r', true, false, false, true, 0, { 0 } }, \
{ 1255, {"prorows"},		   700, -1, 4,	6, 0, -1, -1, FLOAT4PASSBYVAL, 'p', 'i', 'r', true, false, false, true, 0, { 0 } }, \
...
{ 1249, {"attname"},	  19, -1, NAMEDATALEN,	2, 0, -1, -1, false, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
...
{ 1259, {"reltuples"},	   700, -1, 4,	9, 0, -1, -1, FLOAT4PASSBYVAL, 'p', 'i', 'r', true, false, false, true, 0, { 0 } }, \
...
{ 1259, {"relistemp"},	   16, -1,	1, 14, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relkind"},	   18, -1,	1, 15, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relnatts"},	   21, -1,	2, 16, 0, -1, -1, true, 'p', 's', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relchecks"},	   21, -1,	2, 17, 0, -1, -1, true, 'p', 's', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relhasoids"},    16, -1,	1, 18, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relhaspkey"},    16, -1,	1, 19, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relhasrules"},   16, -1,	1, 20, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relhastriggers"},16, -1,	1, 21, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relhassubclass"},16, -1,	1, 22, 0, -1, -1, true, 'p', 'c', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relfrozenxid"},  28, -1,	4, 23, 0, -1, -1, true, 'p', 'i', 'r', true, false, false, true, 0, { 0 } }, \
{ 1259, {"relacl"},		 1034, -1, -1, 24, 1, -1, -1, false, 'x', 'i', 'r', false, false, false, true, 0, { 0 } }, \
{ 1259, {"reloptions"},  1009, -1, -1, 25, 1, -1, -1, false, 'x', 'i', 'r', false, false, false, true, 0, { 0 } }
...
DATA(insert ( 1259 relistemp		16 -1 1  14 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relkind			18 -1 1  15 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relnatts			21 -1 2  16 0 -1 -1 t p s r t f f t 0 _null_));
DATA(insert ( 1259 relchecks		21 -1 2  17 0 -1 -1 t p s r t f f t 0 _null_));
DATA(insert ( 1259 relhasoids		16 -1 1  18 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relhaspkey		16 -1 1  19 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relhasrules		16 -1 1  20 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relhastriggers	16 -1 1  21 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relhassubclass	16 -1 1  22 0 -1 -1 t p c r t f f t 0 _null_));
DATA(insert ( 1259 relfrozenxid		28 -1 4  23 0 -1 -1 t p i r t f f t 0 _null_));
DATA(insert ( 1259 relacl		  1034 -1 -1 24 1 -1 -1 f x i r f f f t 0 _null_));
DATA(insert ( 1259 reloptions	  1009 -1 -1 25 1 -1 -1 f x i r f f f t 0 _null_));
