# SELinux binding for PHP / Reference manual #
...
This configured context can be applied prior to library functions that internally perform a socket creation, in order to set a socket context on the objects.
